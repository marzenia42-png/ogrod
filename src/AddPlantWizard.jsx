          ...
          {step === 1 && !identifyMode && (
            <>
              <button
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(130,198,138,0.18), rgba(108,184,118,0.10))',
                  border: '0.5px dashed rgba(108, 184, 118, 0.45)',
                  color: '#3D8C4F',
                  fontSize: 13,
                  fontWeight: 500,
                }}
                ...
                {PLANT_CATEGORIES.map((c) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: active
                          ? 'linear-gradient(135deg, rgba(201,169,110,0.25), rgba(130,198,138,0.15))'
                          : 'var(--surface-faint)',
              ...
              {!photoPreview && (
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(130,198,138,0.25), rgba(108,184,118,0.15))',
                      border: '0.5px solid rgba(108, 184, 118, 0.45)',
                      color: '#3D8C4F',
                      fontSize: 15,
                      fontWeight: 500,
                    }}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {!identifying && identifications === null && (
                    <>
                      <button
                        ...
                        style={{
                          background: 'linear-gradient(135deg, #86CF8C, #65BD7A)',
                          color: '#0a0f0a',
                          border: 'none',
                          fontWeight: 600,
                          fontSize: 14,
                  ...
                  {identifying && (
                    <div
                      ...
                      style={{ background: 'rgba(108, 184, 118, 0.08)', border: '0.5px solid rgba(108, 184, 118, 0.25)' }}
                    >
                      <span style={{ fontSize: 24 }}>🌿</span>
                      <span className="font-serif italic" style={{ color: '#3D8C4F', fontSize: 14 }}>
                        FLORA myśli...
                      </span>
                    </div>
                  )}
                  ...
                  {!identifying && Array.isArray(identifications) && identifications.length > 0 && (
                    <div>
                      <p
                        ...
                        style={{ color: 'rgba(60, 132, 78, 0.8)' }}
                      >
                        🌿 FLORA proponuje
                      </p>
                        ...
                        {identifications.map((it, i) => {
                          ...
                          return (
                            <button
                              ...
                              style={{
                                background: i === 0
                                  ? 'linear-gradient(135deg, rgba(130,198,138,0.18), rgba(108,184,118,0.10))'
                                  : 'var(--surface-faint)',
                                border: i === 0
                                  ? '0.5px solid rgba(108, 184, 118, 0.45)'
                            ...
                            >
                              ...
                              <span
                                style={{
                                  fontSize: 11,
                                  color: conf >= 60 ? '#3D8C4F' : conf >= 30 ? 'var(--gold-label-strong)' : 'var(--text-muted)',
                                  fontWeight: 500,
                                  minWidth: 44,
                                  textAlign: 'right',
              ...
              {speciesList.map((s) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: active
                        ? 'linear-gradient(135deg, rgba(201,169,110,0.28), rgba(130,198,138,0.14))'
            ...
            <div>
              ...
              {(isCustomNameMode ? customName.trim().length >= 3 : !!selectedSpecies) && (
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgba(130,198,138,0.18), rgba(201,169,110,0.10))',
                    border: '1px solid rgba(130,198,138,0.40)',
                  }}
                >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: wantsFloraSpec === true
                          ? 'linear-gradient(135deg, #86CF8C, #65BD7A)'
                          : 'rgba(130,198,138,0.15)',
                        color: wantsFloraSpec === true ? '#0a0f0a' : '#3D8C4F',
                        border: wantsFloraSpec === true ? 'none' : '1px solid rgba(108,184,118,0.45)',
