  ...
  return (
    <div className="px-5 pb-10">
      <div className="flex items-center justify-between mb-3">
        <p className="text-[11px] tracking-[2px] uppercase" style={{ color: 'rgba(165, 226, 168, 0.7)' }}>
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, #65BD7A, #3D8C4F)',
            color: '#0a0f0a',
            border: 'none',
            fontWeight: 500,
          }}
        ...
        {[{ key: 'all', label: 'Wszystkie' }, ...RECIPE_TYPES].map((t) => {
          ...
          return (
            <button
              ...
              style={{
                background: active ? 'rgba(108, 184, 118, 0.25)' : 'var(--surface-card-soft)',
                border: active ? '0.5px solid #65BD7A' : '0.5px solid rgba(165, 226, 168, 0.2)',
                color: active ? '#A6E6A8' : 'var(--text-muted)',
            ...
            >
              ...
              >
                <div className="flex-1 min-w-0">
                  <span className="font-serif italic block truncate" style={{ color: '#A6E6A8', fontSize: '16px' }}>
                    🌿 {r.name}
                    {r.custom && <span className="ml-2 text-[10px] font-normal" style={{ color: 'rgba(165,226,168,0.5)' }}>własna</span>}
                  </span>
                  <span className="text-[10px] tracking-[2px] uppercase" style={{ color: 'rgba(165,226,168,0.6)' }}>
                    {typeMeta.label}
                  </span>
                </div>
                <span style={{ color: 'rgba(165, 226, 168, 0.6)', transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 0.25s ease' }}>
              ...
              {open && (
                <div className="px-4 pb-4 pt-1 flex flex-col gap-3" style={{ borderTop: '0.5px solid rgba(165, 226, 168, 0.2)' }}>
                  {r.photoData && (
                    <img
                      src={r.photoData}
                      alt=""
                      style={{ width: '100%', maxHeight: '180px', objectFit: 'cover', borderRadius: '10px', border: '0.5px solid rgba(165, 226, 168, 0.25)' }}
                    />
                  )}
                  {r.target && (
                    <div>
                      <p className="text-[10px] tracking-[2px] uppercase mb-1" style={{ color: 'rgba(165, 226, 168, 0.55)' }}>
                        Na co działa
                      </p>
                  ...
                  <div>
                    ...
                    <ol className="flex flex-col gap-1.5">
                      {r.steps.map((s, i) => (
                        ...
                        >
                          <span style={{ color: '#A6E6A8', fontWeight: 500, minWidth: '20px' }}>{i + 1}.</span>
                          <span>{s}</span>
                        </li>
                      ))}
                    </ol>
                  ...
                  {r.custom ? (
                    ...
                    <div className="flex gap-2 self-end mt-2">
                      <button
                        ...
                        className="cursor-pointer"
                        style={{ padding: '5px 10px', borderRadius: 8, background: 'rgba(130,198,138,0.10)', border: '0.5px solid rgba(130,198,138,0.35)', color: '#86CF8C', fontSize: 12 }}
      ...
      <div
        ...
        style={{ backgroundColor: 'var(--surface-card)', border: '0.5px solid rgba(165, 226, 168, 0.35)', backdropFilter: 'blur(8px)' }}
      >
        <p className="text-[11px] tracking-[2px] uppercase mb-3" style={{ color: 'rgba(165, 226, 168, 0.7)' }}>
        ...
        <ul className="flex flex-col gap-2">
          {NATURAL_RULES.map((rule, i) => (
            <li
              ...
              style={{ color: 'var(--text-secondary)' }}
            >
              <span style={{ color: '#A6E6A8', marginTop: '6px' }}>•</span>
              <span>{rule}</span>
            </li>
          ))}
        </ul>
        ...
        >
          <div
            ...
            style={{
              ...
              border: '1px solid rgba(165, 226, 168, 0.35)',
              borderRadius: '20px',
            }}
          >
            <div className="flex items-center justify-between px-5 pt-5 pb-3" style={{ borderBottom: '0.5px solid rgba(165, 226, 168, 0.2)' }}>
              <h3 className="font-serif italic" style={{ fontSize: '20px', color: '#A6E6A8' }}>
            ...
            <div className="overflow-y-auto px-5 py-4 flex flex-col gap-3 flex-1">
              <input
                ...
                style={{ border: '0.5px solid rgba(165, 226, 168, 0.25)', color: 'var(--text-primary)' }}
              />

              <div>
                <p className="text-[10px] tracking-[2px] uppercase mb-1.5" style={{ color: 'rgba(165, 226, 168, 0.55)' }}>Typ</p>
                  ...
                  {RECIPE_TYPES.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          background: active ? 'rgba(108, 184, 118, 0.25)' : 'var(--surface-faint)',
                          border: active ? '0.5px solid #65BD7A' : '0.5px solid rgba(165, 226, 168, 0.2)',
                          color: active ? '#A6E6A8' : 'var(--text-secondary)',
                          fontWeight: active ? 500 : 400,
                        }}
                      >
                        {t.label}
              ...
              <div>
                <p className="text-[10px] tracking-[2px] uppercase mb-1.5" style={{ color: 'rgba(165, 226, 168, 0.55)' }}>
                  ...
                  {MONTHS_SHORT.map((m, i) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          border: selected ? '0.5px solid #65BD7A' : '0.5px solid rgba(165, 226, 168, 0.2)',
                          background: selected ? 'rgba(108, 184, 118, 0.20)' : 'transparent',
                          color: selected ? '#A6E6A8' : 'var(--text-muted)',
              ...
              <div>
                <p className="text-[10px] tracking-[2px] uppercase mb-1.5" style={{ color: 'rgba(165, 226, 168, 0.55)' }}>Zdjęcie (opcjonalne)</p>
                <input
                  ref={photoRef}
                  type="file"
                  accept="image/*"
                ...
                />
                {draft.photoData ? (
                  <div className="relative rounded-lg overflow-hidden" style={{ border: '0.5px solid rgba(165, 226, 168, 0.25)' }}>
                  ...
                  <button
                    ...
                    style={{ background: 'none', border: '0.5px dashed rgba(165, 226, 168, 0.4)', color: 'rgba(165, 226, 168, 0.85)' }}
                  >
              ...
              <p className="text-[10px] tracking-[2px] uppercase mt-1" style={{ color: 'rgba(165, 226, 168, 0.55)' }}>
                Kroki
              </p>
              {draft.steps.map((s, i) => (
                <div key={i} className="flex gap-2">
                  <span className="font-serif italic" style={{ color: '#A6E6A8', fontWeight: 500, minWidth: '20px', paddingTop: '8px' }}>{i + 1}.</span>
                  <input
                    type="text" lang="pl" spellCheck={true} autoCorrect="on" autoCapitalize="sentences"
                    value={s}
              ...
              <button
                ...
                style={{ background: 'none', border: '0.5px dashed rgba(165, 226, 168, 0.4)', color: '#A6E6A8' }}
              >
                + dodaj krok
              </button>
