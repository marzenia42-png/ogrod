    ...
    <>
      {!hideFab && (
        <button
          ...
          style={{
            ...
            borderRadius: '50%',
            border: 'none',
            background: 'linear-gradient(135deg, #86CF8C 0%, #C9A96E 100%)',
            cursor: 'pointer',
            zIndex: 999,
            display: 'grid',
            placeItems: 'center',
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid rgba(130, 198, 138, 0.25)',
          borderBottom: 'none',
          display: 'flex',
      ...
      >
        <div
          ...
          style={{ borderBottom: '1px solid rgba(130, 198, 138, 0.15)' }}
        >
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                ...
                height: 36,
                borderRadius: '50%',
                background: 'linear-gradient(135deg, #86CF8C, #C9A96E)',
                display: 'grid',
                placeItems: 'center',
              }}
            >
            ...
            <div>
              <p className="font-serif italic" style={{ fontSize: '18px', color: '#86CF8C', lineHeight: 1.1 }}>FLORA</p>
              <p style={{ fontSize: '10px', letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(130, 198, 138, 0.5)', marginTop: '2px' }}>
                ogrodnik AI
              </p>
            </div>
          </div>
          <div className="flex items-center gap-1">
            {ttsSupported && (
              <button
                ...
                style={{
                  background: ttsOn ? 'rgba(130, 198, 138, 0.18)' : 'none',
                  border: ttsOn ? '0.5px solid rgba(130, 198, 138, 0.5)' : '0.5px solid transparent',
            ...
            <button
              ...
              onClick={() => setOpen(false)}
              aria-label="Zamknij"
              style={{ background: 'none', border: 'none', padding: 8, cursor: 'pointer', color: 'rgba(130, 198, 138, 0.55)' }}
            >
              ...
              >
                <div
                  ...
                  style={m.role === 'assistant'
                    ? {
                        backgroundColor: 'rgba(130, 198, 138, 0.10)',
                        border: '0.5px solid rgba(130, 198, 138, 0.30)',
                    ...
                    : {
                        background: 'linear-gradient(135deg, rgba(130, 198, 138, 0.22), rgba(201, 169, 110, 0.22))',
                        color: 'var(--text-primary)',
                        fontSize: '14px',
                        lineHeight: 1.55,
                        whiteSpace: 'pre-wrap',
                ...
                {isLastDiagnosis && showPlantPicker && (
                  <div
                    ...
                    style={{
                      background: 'rgba(108, 184, 118, 0.08)',
                      border: '0.5px solid rgba(108, 184, 118, 0.35)',
                      maxWidth: '100%',
                    }}
                  >
                    <p className="text-[10px] tracking-[2px] uppercase mb-2" style={{ color: 'rgba(165, 226, 168, 0.7)' }}>
                      Do której rośliny?
                    </p>
                    <div
                      ...
                      {loadAllPlants().map((p) => (
                        <button
                          ...
                          style={{
                            ...
                            border: '0.5px solid rgba(165, 226, 168, 0.3)',
                            color: '#A6E6A8',
                          }}
                        >
                          {p.name}
          ...
          {loading && (
            <div
              ...
              style={{
                ...
                backgroundColor: 'rgba(130, 198, 138, 0.08)',
                border: '0.5px solid rgba(130, 198, 138, 0.22)',
                color: 'rgba(130, 198, 138, 0.7)',
                fontSize: '14px',
              }}
            >
        ...
        <div
          className="px-4 pt-3"
          style={{
            borderTop: '1px solid rgba(130, 198, 138, 0.15)',
        ...
        >
          ...
          {imagePreview && (
            <div
              ...
              style={{ background: 'rgba(130, 198, 138, 0.08)', border: '0.5px solid rgba(130, 198, 138, 0.25)' }}
            >
                ...
                <button
                  ...
                  style={{
                    background: photoMode === 'identify'
                      ? 'linear-gradient(135deg, rgba(130,198,138,0.35), rgba(108,184,118,0.20))'
                      : 'transparent',
                    border: photoMode === 'identify'
                      ? '0.5px solid rgba(108, 184, 118, 0.6)'
                      : '0.5px solid rgba(130, 198, 138, 0.25)',
                    color: photoMode === 'identify' ? '#3D8C4F' : 'var(--text-secondary)',
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--surface-faint)', border: '1px solid rgba(130, 198, 138, 0.30)' }}
          >
            ...
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(130, 198, 138, 0.30), rgba(130, 198, 138, 0.18))',
                border: '0.5px solid rgba(130, 198, 138, 0.55)',
                width: 40,
                height: 40,
                minWidth: 40,
                borderRadius: '50%',
              ...
              <button
                ...
                style={{
                  background: listening
                    ...
                    : 'linear-gradient(135deg, rgba(130, 198, 138, 0.30), rgba(130, 198, 138, 0.18))',
                  border: listening ? '0.5px solid rgba(239,68,68,0.7)' : '0.5px solid rgba(130, 198, 138, 0.55)',
      ...
      {logToast && (
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(108, 184, 118, 0.5)',
            color: '#A6E6A8',
            zIndex: 1200,
          }}
        >
