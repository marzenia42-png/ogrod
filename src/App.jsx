              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: active ? 'linear-gradient(135deg, rgba(201,169,110,0.28), rgba(130,198,138,0.12))' : 'transparent',
            ...
            <div className="flex gap-1.5">
              <button
                ...
                style={{
                  ...
                  background: 'rgba(108,184,118,0.10)',
                ...
                {weather && (() => {
                  ...
                  <>
                    ...
                    {tab === 'kalendarz' && drySprayWindow && !humidityAlert && (
                      <div
                        className="mt-3 px-3 py-2 rounded-lg text-[12px] font-serif italic"
                        style={{ backgroundColor: 'rgba(108, 184, 118, 0.10)', border: '1px solid rgba(108, 184, 118, 0.35)', color: '#A6E6A8' }}
                      >
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        background: isSelected ? 'linear-gradient(135deg, rgba(201,169,110,0.22), rgba(130,198,138,0.12))' : 'var(--surface-card-soft)',
                    ...
                    {PREFERENCE_TYPES.map((pref) => {
                      ...
                      return (
                        <button
                          ...
                          className="py-1.5 px-2 rounded-md text-[11px] cursor-pointer"
                          style={{
                            background: active ? 'rgba(108, 184, 118, 0.20)' : 'transparent',
                            border: active ? '0.5px solid rgba(108, 184, 118, 0.5)' : '0.5px solid var(--border-soft)',
                            color: active ? '#3D8C4F' : 'var(--text-secondary)',
                            fontWeight: active ? 500 : 400,
                          }}
                        >
                          {pref.label}
