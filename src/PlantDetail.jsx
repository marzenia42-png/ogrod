        ...
        {showFloraBanner && (
          <section className="px-5 pb-3">
            <button
              ...
              style={{ background: 'linear-gradient(135deg, rgba(130,198,138,0.18), rgba(201,169,110,0.10))', border: '1px solid rgba(130,198,138,0.40)' }}
            >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: active ? 'linear-gradient(135deg, rgba(201,169,110,0.30), rgba(130,198,138,0.10))' : 'var(--surface-faint)',
